...
public final class Constants {
    ...
    public static final String BOT_USER_AUTHENTICATION_STRATEGY_KEY = "bot.user.authentication.strategy";
    ...
    public static final String AUTHENTICATION_STRATEGY_USERNAMES = "usernames";
    public static final String AUTHENTICATION_STRATEGY_PASSWORD = "password";
